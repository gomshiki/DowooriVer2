...
import com.jun.DowooriVer2.repository.origin.DayoffChartRepository;
...
@Transactional
@Slf4j
public class DayoffChartService {

    private DayoffChartRepository dayoffChartRepository;
    private DeptRepository deptRepository;

    public DayoffChartService(DayoffChartRepository dayoffChartRepository, DeptRepository deptRepository) {
        this.dayoffChartRepository = dayoffChartRepository;
        this.deptRepository = deptRepository;
    }

    public List<ChartDTO> dayoffCnt(Long empNum, Long deptNum) {

        return dayoffChartRepository.dayoffCnt(empNum, deptNum);
    ...
    public List<ChartTeamDTO> teamCnt(Long empNum, Long deptNum) {
        return dayoffChartRepository.teamCnt(empNum, deptNum);
    }
    ...
    public List totalDayoff(String deptNum) {
        ...
        List<DayoffTeamDTO> dayoffTeamDTOS = dayoffChartRepository.totalDayoffCnt(deptNum);
